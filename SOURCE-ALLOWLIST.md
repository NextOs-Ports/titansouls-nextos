...
release metadata, documentation and port-specific build/package recipes.

It does **not** contain NextOS framework source or copies, NXExtract runtime or
UI, the generated nxbootstrap launcher, compiled executables or libraries,
...
compatibilidade de Titan Souls, testes, receita de extração sem dados, metadados
de release, documentação e receitas de build/pacote específicas do port.

Ele **não** contém fontes ou cópias do framework NextOS, runtime/UI do
NXExtract, launcher nxbootstrap gerado, executáveis ou bibliotecas compiladas,
